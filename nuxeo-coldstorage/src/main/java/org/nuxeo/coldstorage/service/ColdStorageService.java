...
public interface ColdStorageService {
     ...
     * <p/>
     * The permission {@value org.nuxeo.coldstorage.ColdStorageConstants#WRITE_COLD_STORAGE} is required.
     *
     ...
     * @since 10.10
     */
    public Blob getRendition(DocumentModel documentModel, CoreSession session);
}
