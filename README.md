...
```
to build the **nuxeo-coldstorage-web** module.
...
## Configuration properties
 ...
 - `nuxeo.coldstorage.migration.restore.enabled` : when set to `true`, blocks move to cold storage operations and enables the migration to exit the cold storage addon. Default value is `false`. See https://doc.nuxeo.com/nxdoc/nuxeo-coldstorage-migration/
